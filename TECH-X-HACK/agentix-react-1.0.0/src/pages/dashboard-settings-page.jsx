...
export default function DashboardSettingsPage() {
    ...
    return (
        <main className="px-6 md:px-16 lg:px-24 xl:px-32 pt-8 md:pt-12 pb-24">
            <section className="flex flex-col items-center" id="settings">
                <div className="w-full max-w-5xl rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
                    <div className="flex flex-wrap items-start justify-between gap-4">
                        <div>
                            ...
                            <h1 className="font-display text-3xl text-slate-900 mt-3">Profile settings for {displayName}</h1>
                            <p className="text-sm text-slate-600 mt-2">Update your basic info and target role for role-based analysis.</p>
                        </div>
